...
class Pokemon(models.Model):
    ...
    date_encountered = models.DateField(default="2015-01-1")
    date_captured = models.DateTimeField(default=timezone.now)
    description = models.TextField(default="Unknown Pokemon", validators=[v.MinLengthValidator(10), v.MaxLengthValidator(150)])
