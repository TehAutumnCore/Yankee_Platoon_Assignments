"""
Django settings for GameManagementProj project.
...
ROOT_URLCONF = 'GameManagementProj.urls'
...
WSGI_APPLICATION = 'GameManagementProj.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'game_management_personal_proj_db',
    }
}
