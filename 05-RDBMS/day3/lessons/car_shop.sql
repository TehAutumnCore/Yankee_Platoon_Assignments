...
-- Create Employees Table many employees to one department
...
CREATE_INDEX idx_car_year on car(year);

COMMENT ON TABLE car IS 'Car has a many to one relationship with driver'
